...
if (uploadedImageData) {
	...
	doc.addImage(imgData, 'JPEG', 15, 30, 50, 50);
}
...
doc.text(`${degree}`, 50, 157);
doc.text(`${university}`, 50, 165);
doc.text(`${year}`, 50, 173);
doc.setFontStyle('bold');
doc.setFontSize(20);
doc.text('Experience', 40, 183);
doc.setFontSize(12);
doc.setFontStyle('normal');
doc.text(`${position}`, 50, 189);
doc.text(`${company}`, 50, 197);
doc.text(`${duration}`, 50, 203);
doc.setFontSize(20);
doc.setFontStyle('bold');
doc.text('Skills', 40, 213);
doc.setFontSize(12);
doc.setFontStyle('normal');
doc.text(`${skill1}`, 50, 219);
doc.text(`${skill2}`, 50, 227);
doc.text(`${skill3}`, 50, 233);
doc.setFontSize(20);
doc.setFontStyle('bold');
doc.text('Contact', 40, 243);
doc.setFontSize(12);
doc.setFontStyle('normal');
doc.text(`Email: ${email}`, 40, 249);
doc.text(`Phone: ${phone}`, 40, 257);
doc.setFontStyle('bold');
doc.setFontSize(24);
doc.text('Additional Information', 10, 270);
doc.text('and Achievments', 10, 280);
doc.setFontSize(16);
doc.setFontStyle('normal')
var textLines = doc.splitTextToSize(about, 155);
var lineHeight = 5;
var y = 125;
...
var textLines = doc.splitTextToSize(description, 90);
var lineHeight = 5;
var y = 270;
for (var i = 0; i < textLines.length; i++) {
